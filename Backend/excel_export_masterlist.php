...
'MATH 1', 'MATH 2', 'MATH 3' , 'SCIENCE 1', 'SCIENCE 2', 'SCIENCE 3' , 'ENGLISH 1', 'ENGLISH 2', 'ENGLISH 3', 'GWA', 'RESULT'); 
...
if($query->num_rows > 0){ 
    while($row = $query->fetch_assoc()){ 
        ...
        $row['academic_classification'], $row['math_grade'], $row['math_2'], $row['math_3'], $row['science_grade'], $row['science_2'], $row['science_3'],
         $row['english_grade'], $row['english_2'], $row['english_3'], $row['gwa_grade'], $row['Result']);  
        $excelData[] = $lineData; 
    } 
} 

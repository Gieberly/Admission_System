...
$sql = "SELECT * FROM `programs` WHERE `Courses` LIKE '%$search%' OR `Nature_of_Degree` LIKE '%$search%'";
                    ...
                    <div class="order">
                        <div class="head">
                            ...
                            <div class="headfornaturetosort">
                                ...
                                <button type="button" class="search-btn" onclick="searchData()"><i class='bx bx-search'></i></button>
                        ...
                        <div id="table-container">
                            <table id="searchableTable">
                                ...
                                <tbody>
                                    <!-- Placeholder row for adding a new course -->
...
function searchData() {
    ...
    var rows = document.getElementById('searchableTable').querySelectorAll('tbody tr');

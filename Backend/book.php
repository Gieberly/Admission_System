...
if(isset($_POST['submit_appo'])){
    ...
    $query = "INSERT INTO appointments (FIRSTNAME, MIDDLENAME, LASTNAME, EMAIL, DATE, AUTONUM) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($query);
    $stmt->bind_param('ssssss', $fname, $mname, $lname, $email, $date, $autonum);
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="" msethod="POST" autocomplete="off">
                    ...
                    <button type="submit" name="submit_appo" class="btn btn-primary"> Submit </button>

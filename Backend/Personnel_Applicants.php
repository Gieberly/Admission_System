    ...
    <div class="container">
        <div class="grade-group">
            ...
            <div class="field-group">
                ...
                <input name="Requirements" class="input" autocomplete="off" id="Requirements" value="<?php echo $admissionData['Requirements']; ?>" readonly>
                <!-- Requirements_Remarks -->
                <label class="small-label" for="Requirements_Remarks">Requirements Remarks</label>
                <input name="Requirements_Remarks" class="input" autocomplete="off" id="Requirements_Remarks" value="<?php echo $admissionData['Requirements_Remarks']; ?>" readonly>
                <!-- OSS_Endorsement_Slip -->
                <label class="small-label" for="OSS_Endorsement_Slip">OSS Endorsement Slip</label>
                <input name="OSS_Endorsement_Slip" class="input" autocomplete="off" id="OSS_Endorsement_Slip" value="<?php echo $admissionData['OSS_Endorsement_Slip']; ?>" readonly>
                <!-- OSS_Admission_Test_Score -->
                <label class="small-label" for="OSS_Admission_Test_Score">OSS Admission Test Score</label>
                <input name="OSS_Admission_Test_Score" class="input" autocomplete="off" id="OSS_Admission_Test_Score" placeholder="Enter Grade" value="<?php echo $admissionData['OSS_Admission_Test_Score']; ?>" readonly>
            </div>

            <!-- Repeat the same structure for the next set of fields -->
            <div class="field-group">
                <!-- OSS_Remarks -->
                <label class="small-label" for="OSS_Remarks">OSS Remarks</label>
                <input name="OSS_Remarks" class="input" autocomplete="off" id="OSS_Remarks" value="<?php echo $admissionData['OSS_Remarks']; ?>" readonly>
                ...
                <!-- Interview_Result -->
                <label class="small-label" for="Interview_Result">Interview Result</label>
                <input name="Interview_Result" class="input" autocomplete="off" id="Interview_Result" value="<?php echo $admissionData['Interview_Result']; ?>" readonly>
                <!-- Endorsed -->
                <label class="small-label" for="Endorsed">Endorsed</label>
                <input name="Endorsed" class="input" autocomplete="off" id="Endorsed" value="<?php echo $admissionData['Endorsed']; ?>" readonly>
            </div>

            <!-- Repeat the same structure for the next set of fields -->
            <div class="field-group">
                <!-- Confirmed_Slot -->
                <label class="small-label" for="Confirmed_Slot">Confirmed Slot</label>
                <input name="Confirmed_Slot" class="input" autocomplete="off" id="Confirmed_Slot" value="<?php echo $admissionData['Confirmed_Slot']; ?>" readonly>
                <!-- Final_Remarks -->
                <label class="small-label" for="Final_Remarks">Final Remarks</label>
                <input name="Final_Remarks" class="input" autocomplete="off" id="Final_Remarks" value="<?php echo $admissionData['Final_Remarks']; ?>" readonly>
            </div>
        </div>
    </div>
    <br>

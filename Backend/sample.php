            ...
            <form id="updateProfileForm" class="tab1-content" method="post" action="Personnel_SubmitForm.php">
              ...
              <div class="Subjects" style="display: none;">
                ...
                <div class="form-container2">
                  ...
                  <div class="form-group"> <!-- English_Other_Courses_Grade -->
                    <label class="small-label" for="English_Other_Courses_Grade_2">English 5</label>
                    <input name="English_Other_Courses_Grade_2" class="input numeric-input" autocomplete="off" id="English_Other_Courses_Grade_2" placeholder="Enter Grade" value="<?php echo $admissionData['English_Other_Courses_Grade_2']; ?>">
                  </div>
                  <div class="form-group"> <!-- English_Other_Courses_Grade -->
                    <label class="small-label" for="English_Other_Courses_Grade_3">English 6</label>
                    <input name="English_Other_Courses_Grade_3" class="input numeric-input" autocomplete="off" id="English_Other_Courses_Grade_3" placeholder="Enter Grade" value="<?php echo $admissionData['English_Other_Courses_Grade_3']; ?>">
                  </div>
                </div>
                ...
                <div class="form-container3">
                  ...
                  <div class="form-group">
                    <!-- Science_Other_Courses_Grade -->
                    <label class="small-label" for="Science_Other_Courses_Grade_2">Science 6</label>
                  ...
                  <div class="form-group">
                    <!-- Science_Other_Courses_Grade -->
                    <label class="small-label" for="Science_Other_Courses_Grade_3">Science 7</label>
                ...
                <p class="personal_information">Grade in Math</p>
                  ...
                  <div class="form-group">
                    <!-- Math_Other_Courses_Grade -->
                    <label class="small-label" for="Math_Other_Courses_Grade_2">Math 4</label>
                  ...
                  <div class="form-group">
                    <!-- Math_Other_Courses_Grade -->
                    <label class="small-label" for="Math_Other_Courses_Grade_3">Math 5</label>
        ...
        if (!$(event.target).is('button') && !$(event.target).is('i') && !$(event.target).is(':checkbox')) {
          ...
          $.ajax({
            ...
            success: function(response) {
              ...
              $('.SHS-Graduate-Average, .Admission_Score,.Gr-12-Average, .ALS, .Subjects, .GWA-OTAS, .Transferee, .Gr-12, .HS-Graduate, .2nd-degree').hide(); // Hide all divs first
              if (academicClassification === 'Senior High School Graduates') {
                $('.SHS-Graduate-Average, .Subjects , .Admission_Score').show();
              } else if (academicClassification === 'Grade 12') {
                $('.Gr-12-Average, .Subjects, .Admission_Score').show();
              } else if (academicClassification === 'Transferees') {
                $('.Transferee, .GWA-OTAS, .Admission_Score').show();
              } else if (academicClassification === 'ALS/PEPT Completers') {
                $('.ALS, .GWA-OTAS, .Admission_Score').show();
              } else if (academicClassification === 'High School (Old Curriculum) Graduates') {
                $('.HS-Graduate, .GWA-OTAS, .Admission_Score').show();
              } else if (academicClassification === 'Second Degree') {
                $('.2nd-degree, .GWA-OTAS, .Admission_Score').show();
              }
